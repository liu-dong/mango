...
public interface BackupConstants {
	...
	/**
	 * 备份程序的路径 即mysqldump的路径
	 */
	public static final String BACKUP_EXE_PATH = "D:\\\"MySQL\\MySQL Server 5.7\\bin\"\\";
	/** 备份目录名称 */
	public static final String BACKUP_FOLDER_NAME = "mango_backup";
	/** 备份目录 */
	public static final String BACKUP_FOLDER = "G:" + File.separator + BACKUP_FOLDER_NAME + File.separator;
	/** 还原目录，默认就是备份目录 */
